...
def AliexpressProductScraper(productId, feedbackLimit=None):
    ...
    result = {
        ...
        "salePrice": {
            "min": data["priceComponent"]["discountPrice"]["minActivityAmount"]["value"]
            if ("minActivityAmount" in data["priceComponent"]["discountPrice"])
            else data["priceComponent"]["discountPrice"]["minAmount"]["value"],
            "max": data["priceComponent"]["discountPrice"]["maxActivityAmount"]["value"]
            if ("maxActivityAmount" in data["priceComponent"]["discountPrice"])
            else data["priceComponent"]["discountPrice"]["maxAmount"]["value"],
        },
    }
